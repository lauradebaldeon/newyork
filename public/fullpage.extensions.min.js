...
!(function(e, t, n, o, r) {
  ...
  function Qn() {
    return "innerHeight" in an
      ? an.innerHeight
      : sn.documentElement.offsetHeight;
  }
  function _n() {
  ...
  function no(e, t) {
    e = io(e) ? e[0] : e;
    for (
      var n = null != t ? Gn(t, e.parentNode) : e.parentNode.childNodes,
        o = 0,
        r = 0;
      r < n.length;
      r++
  ...
  function uo(e, t) {
    for (
      "string" == typeof t && (t = xo(t)), e.appendChild(t);
      e.firstChild !== t;
  ...
  function wo(e, t, n) {
    var o;
    (n = void 0 === n ? {} : n),
      "function" == typeof an.CustomEvent
  ...
  return (
    ...
    function(e, g) {
      var n =
          ...
          -1 < sn.domain.indexOf("alvarotrigo.com"),
        r = Gn("html, body"),
        s = Gn("html")[0],
        m = Gn("body")[0];
      if (!Un(s, pn)) {
        ...
        g = Fn(
          {
            ...
            scrollOverflowHandler: an.fp_scrolloverflow
              ? an.fp_scrolloverflow.iscrollHandler
              : null,
          ...
          w &&
            ...
            (S.test = {
              ...
              translate3dH: (function() {
                for (
                  var e = [], t = 0;
                  t < Gn(g.sectionSelector, w).length;
                  t++
                )
            ...
            (S.shared = { afterRenderActions: Ce, isNormalScrollElement: !1 }),
            (an.fullpage_api = S),
            ...
            (function() {
              Jn(w, { height: "100%", position: "relative" }),
                lo(w, cn),
                lo(s, pn),
                (y = Qn()),
                ao(w, vn),
              ...
              g.fixedElements &&
                g.css3 &&
                Gn(g.fixedElements).forEach(function(e) {
                  m.appendChild(e);
                }),
                g.navigation &&
                  (function() {
      ...
      function re(e, t) {
        ...
        if (g.autoScrolling && !g.scrollBar)
          Jn(r, { overflow: "hidden", height: "100%" }),
            ie(V.recordHistory, "internal"),
            Jn(w, { "-ms-touch-action": "none", "touch-action": "none" }),
            null != n && Gt(n.offsetTop);
        else if (
          (Jn(r, { overflow: "hidden", height: "initial" }),
          ie(!!g.autoScrolling && V.recordHistory, "internal"),
          Jn(w, { "-ms-touch-action": "", "touch-action": "" }),
          Qt(w),
          null != n)
        ) {
        ...
        e
          ? ((function() {
              ...
              an.addEventListener
                ...
                : ((e = "attachEvent"), (t = "on"));
              var n =
                  "onwheel" in sn.createElement("div")
                    ? "wheel"
                    : void 0 !== sn.onmousewheel
                    ? "mousewheel"
                    : "DOMMouseScroll",
                o = !!j && { passive: !1 };
              "DOMMouseScroll" == n
                ? sn[e](t + "MozMousePixelScroll", We, o)
                : sn[e](t + n, We, o);
            })(),
            w.addEventListener("mousedown", pt),
            w.addEventListener("mouseup", ht))
          : (sn.addEventListener
              ? (sn.removeEventListener("mousewheel", We, !1),
                sn.removeEventListener("wheel", We, !1),
                sn.removeEventListener("MozMousePixelScroll", We, !1))
              : sn.detachEvent("onmousewheel", We),
      ...
      function ce(t, e) {
        void 0 !== e
          ...
          : Ut(t, "all", "m"),
          wo(w, "setAllowScrolling", { value: t, directions: e });
      }
      function ue(e) {
        e
          ? (se(!0),
            (function() {
              if (
                (l || u) &&
                (!_t("dragAndMove") || "mouseonly" === g.dragAndMove)
              ) {
                g.autoScrolling &&
                  (m.removeEventListener(I.touchmove, ze, { passive: !1 }),
                  m.addEventListener(I.touchmove, ze, { passive: !1 }));
                var e = g.touchWrapper;
                e.removeEventListener(I.touchstart, je),
                  e.removeEventListener(I.touchmove, Be, { passive: !1 }),
                  e.addEventListener(I.touchstart, je),
                  e.addEventListener(I.touchmove, Be, { passive: !1 });
              }
            })())
          : (se(!1),
            (function() {
              if (l || u) {
                g.autoScrolling &&
                  (m.removeEventListener(I.touchmove, Be, { passive: !1 }),
                  m.removeEventListener(I.touchmove, ze, { passive: !1 }));
                var e = g.touchWrapper;
                e.removeEventListener(I.touchstart, je),
                  e.removeEventListener(I.touchmove, Be, { passive: !1 });
        ...
        if (!Un(w, vn)) {
          ...
          for (var t = Gn(wn), n = 0; n < t.length; ++n) {
            var o = t[n],
              r = Gn(In, o)[0],
              i = Gn(Cn, o);
            g.verticalCentered && Jn(Gn(xn, o), { height: It(o) + "px" }),
              Jn(o, { height: Te(o) + "px" }),
          ...
          l && !_t("fadingEffect") && pe(l + 1),
            ...
            bo(g.afterResize) &&
              e &&
              g.afterResize.call(w, an.innerWidth, an.innerHeight),
      ...
      function ye(e) {
        ...
        t && vo(t, Tn + " a")
          ...
          : vo(t, g.menu + " [data-menuanchor]") &&
            function(e) {
              !Gn(g.menu)[0] ||
                (!g.lockAnchors && g.anchors.length) ||
                (So(e), he(this.getAttribute("data-menuanchor")));
            }.call(t, e);
      }
      function Ee(e, t) {
      ...
      function xe(e) {
        ...
        if (i == sn || !i)
          return ue(!0), void (r && g.scrollOverflowHandler.setIscroll(i, !0));
        "touchend" === t &&
          ((X = !1),
          setTimeout(function() {
            X = !0;
            ...
            (g.normalScrollElements.split(",").forEach(function(e) {
              if (!o) {
                var t = yo(i, e),
                  n = vo(i, e);
                (t || n) &&
                  (S.shared.isNormalScrollElement ||
                    (ue(!1), r && g.scrollOverflowHandler.setIscroll(i, !1)),
        ...
        (s.className = zn),
          ...
          1 < n &&
            (g.controlArrows &&
              ((l = e),
              (a = [
                xo('<div class="fp-controlArrow fp-prev"></div>'),
                xo('<div class="fp-controlArrow fp-next"></div>')
              ]),
              po(Gn(In, l)[0], a),
              "#fff" !== g.controlArrowColor &&
                (Jn(Gn(Zn, l), {
                  "border-color":
                    "transparent transparent transparent " + g.controlArrowColor
                }),
                Jn(Gn(Vn, l), {
                  "border-color":
                    "transparent " +
            ...
            g.slidesNavigation &&
              (function(e, t) {
                ...
                Jn(n, { "margin-left": "-" + n.innerWidth / 2 + "px" }),
                  lo(Gn("a", Gn("li", n)[0]), gn);
              })(e, n)),
          t.forEach(function(e) {
            Jn(e, { width: r + "%" }), g.verticalCentered && Rt(e);
          });
        var c = Gn(Hn, e)[0];
        null != c &&
        (0 !== no(Gn(yn), wn) || (0 === no(Gn(yn), wn) && 0 !== no(c)))
          ? (Xt(c, "internal"), lo(c, "fp-initial"))
          : lo(t[0], gn);
      }
      function Te(e) {
        return g.offsetSections && S.offsetSections
          ? Math.round(S.offsetSections.getWindowHeight(e))
          : Qn();
      }
      function Oe(e, t) {
        t || null != Gn(yn)[0] || lo(e, gn),
          (o = Gn(yn)[0]),
          Jn(e, { height: Te(e) + "px" }),
          g.paddingTop && Jn(e, { "padding-top": g.paddingTop }),
          g.paddingBottom && Jn(e, { "padding-bottom": g.paddingBottom }),
          void 0 !== g.sectionsColor[t] &&
            Jn(e, { "background-color": g.sectionsColor[t] }),
          void 0 !== g.anchors[t] &&
      ...
      function Ce() {
        ...
        lo(n, Sn),
          ...
          (e = ft()),
          (t = Bt(e.section)),
          (e.section && t && (void 0 === t || no(t) !== no(o))) ||
            !bo(g.afterLoad) ||
            Xe("afterLoad", {
              activeSection: n,
              element: n,
      ...
      function He() {
        ...
        if (
          ...
          var t = _t("dragAndMove")
            ...
            r =
              (_t("dragAndMove")
                ? S.dragAndMove.getDocumentHeight()
                : m.offsetHeight - Qn()) === t,
            i = Gn(wn);
          if (r) n = i.length - 1;
          else if (t)
          ...
          if (!Un((e = i[n]), gn)) {
            ...
            p && ((s = p.getAttribute("data-anchor")), (a = no(p))),
              x &&
                (lo(e, gn),
                ao(mo(e), gn),
      ...
      function Ie(e) {
        if (v.m[e]) {
          var t = "down" === e ? ve : de;
          if (
            (_t("scrollHorizontally") &&
              (t = S.scrollHorizontally.getScrollSection(e, t)),
            g.scrollOverflow)
          ) {
      ...
      function Be(e) {
        ...
        if (Ne(e)) {
          ...
          ($ = n.y),
            (q = n.x),
            Gn(In, t).length && Math.abs(K - q) > Math.abs(J - $)
              ? !a &&
                Math.abs(K - q) > (_n() / 100) * g.touchSensitivity &&
                (q < K ? v.m.right && ge(t) : v.m.left && me(t))
              : g.autoScrolling &&
                x &&
                Math.abs(J - $) > (an.innerHeight / 100) * g.touchSensitivity &&
                ($ < J ? Ie("down") : J < $ && Ie("up"));
        }
      }
      function Ne(e) {
      ...
      function Ve(e) {
        var t = e.offsetHeight,
          ...
          o = n,
          r =
            _t("dragAndMove") && S.dragAndMove.isGrabbing
              ? S.dragAndMove.isScrollingDown()
              : te < n,
          i = o - y + t,
        ...
        return (
          ...
          g.offsetSections &&
            S.offsetSections &&
            (o = S.offsetSections.getSectionPosition(r, o, e)),
          (te = o)
        );
      }
      function Ze(e, t, n) {
          ...
          if (
            ...
            Jt("parallax", "apply", i),
              ...
              g.autoScrolling &&
                ...
                ((s = i).isMovementUp
                  ? ho(Gn(yn)[0], Lo(s.activeSection, wn))
                  : po(Gn(yn)[0], Mo(s.activeSection, wn).reverse()),
                ...
                (i = s)),
              _t("scrollOverflowReset") &&
                S.scrollOverflowReset.setPrevious(i.activeSection),
      ...
      function Ue(e) {
        ...
        return (
          g.autoScrolling && !g.scrollBar
            ? ((t.options = -e), (t.element = Gn(un)[0]))
            : ((t.options = e), (t.element = an)),
          t
        );
      }
      function Qe(e) {
        ...
        null != (t = e).wrapAroundElements &&
          (t.isMovementUp
            ? ho(Gn(wn)[0], t.wrapAroundElements)
            : po(Gn(wn)[Gn(wn).length - 1], t.wrapAroundElements),
          Gt(Gn(yn)[0].offsetTop),
          Ye(),
      ...
      function Je() {
        var e =
          Gn(".fp-auto-height")[0] ||
          (be() && Gn(".fp-auto-height-responsive")[0]);
        g.lazyLoading &&
          e &&
          Gn(wn + ":not(" + mn + ")").forEach(function(e) {
            var t, n, o;
      ...
      function rt(f) {
        var d = void 0 !== G[f] && G[f].length,
          ...
          v = !1;
        return (
          io(G[f]) ? (e = G[f]) : e.push(G[f]),
          e.forEach(function(e) {
            var t = (function() {
                if (sn.domain.length) {
                  for (
                    var e = sn.domain.replace(/^(www\.)/, "").split(".");
                    2 < e.length;
            ...
            var s = d ? ot(e) : "",
              c =
                1 < (s = s.split("_")).length &&
                -1 < s[1].indexOf(f, s[1].length - f.length),
      ...
      function at(e) {
        if (
          ...
          (U.innerHTML = F),
          (U = U.firstChild),
          "MutationObserver" in an &&
            new MutationObserver(it).observe(sn.body, {
              childList: !0,
              subtree: !1
            }),
          (!B || (_t(e) && S[e])) && (!rt(e) || !B))
      ...
      function st() {
        U &&
          (z || (Math.random() < 0.5 ? To(m, U) : so(U, m), (z = !0)),
          U.setAttribute(
            "style",
            ot(
      ...
      function dt(e) {
        ...
        9 === n
          ...
          : yo(t, "textarea") ||
            ...
            !g.keyboardScrolling ||
            !g.autoScrolling ||
            (-1 < [40, 38, 32, 33, 34].indexOf(n) && So(e),
            (c = e.ctrlKey),
      ...
      function bt(e) {
        g.autoScrolling &&
          (x &&
            (e.pageY < ne && v.m.up ? de() : e.pageY > ne && v.m.down && ve()),
          (ne = e.pageY));
      }
      function wt(e, t, n) {
        var o = vo(e, wn),
        ...
        (r.xMovement = Ht(r.prevSlideIndex, r.slideIndex)),
          ...
          !1 === Xe("onSlideLeave", r)
            ...
            : (lo(t, gn),
              ...
              Un(o, gn) &&
                !r.localIsResizing &&
                Pt(r.slideIndex, r.slideAnchor, r.anchorLink, r.sectionIndex),
              S.continuousHorizontal && S.continuousHorizontal.apply(r),
              $t() ? Et(r) : xt(e, r, !0),
              g.interlockedSlides &&
                S.interlockedSlides &&
                ((_t("continuousHorizontal") &&
                  void 0 !== n &&
                  n !== r.xMovement) ||
                  S.interlockedSlides.apply(r)));
      }
      function yt(e) {
        !g.loopHorizontal &&
          g.controlArrows &&
          (Eo(Gn(Vn, e.section), 0 !== e.slideIndex),
      ...
      function Et(e) {
        ...
        S.continuousHorizontal && S.continuousHorizontal.afterSlideLoads(e),
          ...
          g.slidesNavigation &&
            null != t &&
            (ao(Gn(mn, t), gn), lo(Gn("a", Gn("li", t)[n]), gn)),
          e.localIsResizing ||
            (Jt("parallax", "afterSlideLoads"),
      ...
      function Lt() {
        if ((wo(w, "onResize"), Mt(), l)) {
          ...
          if (!yo(e, "textarea") && !yo(e, "input") && !yo(e, "select")) {
            var t = Qn();
            Math.abs(t - oe) > (20 * Math.max(oe, t)) / 100 &&
              (Se(!0), (oe = t));
          }
        } else Ae();
      }
      ...
      function Tt(e) {
        ...
        return ao(e, dn), Jn(e, { "-webkit-transition": t, transition: t });
      }
      function Ot(e) {
        return lo(e, dn);
      }
      ...
      function Nt(e, t) {
        ...
        if (null != n) {
          var o,
            ...
            l =
              (null ==
                (i = Gn(Cn + '[data-anchor="' + (o = t) + '"]', (r = n))[0]) &&
                ((o = void 0 !== o ? o : 0), (i = Gn(Cn, r)[o])),
              i);
          Dt(n) === b || Un(n, gn)
            ? jt(l)
            : Ze(n, function() {
      ...
      function Qt(e) {
        return Jn(e, { "-webkit-transition": "none", transition: "none" });
      }
      function _t(e) {
        return null !== g[e] &&
      ...
      function nn(e, t) {
        !g.autoScrolling || g.scrollBar || (e.self != an && Un(e, Rn))
          ? e.self != an && Un(e, Rn)
            ? (e.scrollLeft = t)
            : e.scrollTo(0, t)
          : (e.style.top = t + "px");
